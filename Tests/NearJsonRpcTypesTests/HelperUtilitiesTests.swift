...
struct HelperUtilitiesTests {
    ...
    func anyCodableComplexJSON() throws {
        let jsonString = """
        {
            "id": 123,
            "name": "Test",
    ...
    func anyCodingKeySpecialCharacters() {
    ...
    func decodingErrorTypeMismatch() throws {
    ...
    func decodingErrorKeyNotFound() throws {
        struct TestStruct: Codable {
    ...
    func decodingErrorDataCorrupted() throws {
        struct TestStruct: Codable {
            let value: String
        }
    ...
    func decodingErrorNestedPath() throws {
    ...
    func decodingErrorArrayIndex() throws {
        struct Item: Codable {
            let id: Int
        }
    ...
    func anyCodableInStruct() throws {
