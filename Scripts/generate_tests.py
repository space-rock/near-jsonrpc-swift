...
Unified script to generate all test files for NEAR JSON-RPC Swift SDK

This script combines the functionality of:
- generate_tests.py: Generate basic decoding/encoding tests
- enhance_coverage.py: Generate enhanced coverage tests with property access
- generate_client_method_tests.py: Generate comprehensive client method tests
...
# =============================================================================
# TYPES DECODING TESTS GENERATOR
# =============================================================================
