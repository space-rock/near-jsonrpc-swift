...
extension NearJsonRpcClient {
    ...
    public func experimentalChanges(_ request: RpcStateChangesInBlockByTypeRequest) async throws -> RpcStateChangesInBlockResponse {
    ...
    public func experimentalChangesInBlock(_ request: RpcStateChangesInBlockRequest) async throws -> RpcStateChangesInBlockByTypeResponse {
    ...
    public func experimentalCongestionLevel(_ request: RpcCongestionLevelRequest) async throws -> RpcCongestionLevelResponse {
    ...
    public func experimentalGenesisConfig(_ request: GenesisConfigRequest) async throws -> GenesisConfig {
    ...
    public func experimentalLightClientBlockProof(_ request: RpcLightClientBlockProofRequest) async throws -> RpcLightClientBlockProofResponse {
    ...
    /// Returns the proofs for a transaction execution.
    public func experimentalLightClientProof(_ request: RpcLightClientExecutionProofRequest) async throws -> RpcLightClientExecutionProofResponse {
    ...
    public func experimentalMaintenanceWindows(_ request: RpcMaintenanceWindowsRequest) async throws -> [RangeOfUint64] {
    ...
    public func experimentalProtocolConfig(_ request: RpcProtocolConfigRequest) async throws -> RpcProtocolConfigResponse {
    ...
    public func experimentalReceipt(_ request: RpcReceiptRequest) async throws -> RpcReceiptResponse {
    ...
    public func experimentalSplitStorageInfo(_ request: RpcSplitStorageInfoRequest) async throws -> RpcSplitStorageInfoResponse {
    ...
    public func experimentalTxStatus(_ request: RpcTransactionStatusRequest) async throws -> RpcTransactionResponse {
    ...
    public func experimentalValidatorsOrdered(_ request: RpcValidatorsOrderedRequest) async throws -> [ValidatorStakeView] {
    ...
    public func block(_ request: RpcBlockRequest) async throws -> RpcBlockResponse {
    ...
    public func blockEffects(_ request: RpcStateChangesInBlockRequest) async throws -> RpcStateChangesInBlockByTypeResponse {
        let response: JsonRpcResponseForRpcStateChangesInBlockByTypeResponseAndRpcError = try await performRequest(
    ...
    public func broadcastTxAsync(_ request: RpcSendTransactionRequest) async throws -> CryptoHash {
    ...
    public func broadcastTxCommit(_ request: RpcSendTransactionRequest) async throws -> RpcTransactionResponse {
        let response: JsonRpcResponseForRpcTransactionResponseAndRpcError = try await performRequest(
    ...
    public func changes(_ request: RpcStateChangesInBlockByTypeRequest) async throws -> RpcStateChangesInBlockResponse {
        let response: JsonRpcResponseForRpcStateChangesInBlockResponseAndRpcError = try await performRequest(
            method: "changes",
            params: request,
            responseType: JsonRpcResponseForRpcStateChangesInBlockResponseAndRpcError.self
    ...
    public func chunk(_ request: RpcChunkRequest) async throws -> RpcChunkResponse {
    ...
    public func clientConfig(_ request: RpcClientConfigRequest) async throws -> RpcClientConfigResponse {
    ...
    public func gasPrice(_ request: RpcGasPriceRequest) async throws -> RpcGasPriceResponse {
    ...
    public func genesisConfig(_ request: GenesisConfigRequest) async throws -> GenesisConfig {
        let response: JsonRpcResponseForGenesisConfigAndRpcError = try await performRequest(
    ...
    public func health(_ request: RpcHealthRequest) async throws -> RpcHealthResponse? {
    ...
    /// Returns the proofs for a transaction execution.
    public func lightClientProof(_ request: RpcLightClientExecutionProofRequest) async throws -> RpcLightClientExecutionProofResponse {
        let response: JsonRpcResponseForRpcLightClientExecutionProofResponseAndRpcError = try await performRequest(
    ...
    public func maintenanceWindows(_ request: RpcMaintenanceWindowsRequest) async throws -> [RangeOfUint64] {
        let response: JsonRpcResponseForArrayOfRangeOfUint64AndRpcError = try await performRequest(
    ...
    public func networkInfo(_ request: RpcNetworkInfoRequest) async throws -> RpcNetworkInfoResponse {
    ...
    public func nextLightClientBlock(_ request: RpcLightClientNextBlockRequest) async throws -> RpcLightClientNextBlockResponse {
    ...
    public func query(_ request: RpcQueryRequest) async throws -> RpcQueryResponse {
    ...
    public func sendTx(_ request: RpcSendTransactionRequest) async throws -> RpcTransactionResponse {
        let response: JsonRpcResponseForRpcTransactionResponseAndRpcError = try await performRequest(
            method: "send_tx",
            params: request,
            responseType: JsonRpcResponseForRpcTransactionResponseAndRpcError.self
    ...
    public func status(_ request: RpcStatusRequest) async throws -> RpcStatusResponse {
    ...
    public func tx(_ request: RpcTransactionStatusRequest) async throws -> RpcTransactionResponse {
        let response: JsonRpcResponseForRpcTransactionResponseAndRpcError = try await performRequest(
            method: "tx",
            params: request,
            responseType: JsonRpcResponseForRpcTransactionResponseAndRpcError.self
    ...
    public func validators(_ request: RpcValidatorRequest) async throws -> RpcValidatorResponse {
